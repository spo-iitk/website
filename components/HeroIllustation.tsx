...
export default function HeroIllustration() {
	return (
		...
		// 		opacity="0.1"
		// 	/>
		// 	<polygon points="934.03 576.92 935.7 578.6 936.45 575.71 935.65 572.86 933.59 572.86 934.03 576.92" fill="#464a5f" />
		// 	<polygon points="934.03 576.92 935.7 578.6 936.45 575.71 935.65 572.86 933.59 572.86 934.03 576.92" opacity="0.1" />
		// 	<polygon points="934.03 576.92 935.65 578.65 934.03 580.55 932.29 579.9 931.86 579.06 934.03 576.92" fill="#9c9ca1" />
		// 	<polygon points="934.03 576.92 935.65 578.65 934.03 580.55 932.29 579.9 931.86 579.06 934.03 576.92" opacity="0.1" />
		// 	<path
		...
		// 		fill="#1473fa"
		// 	/>
		// 	<ellipse cx="295.09" cy="682.36" rx="23.11" ry="3.17" fill="#1473fa" opacity="0.1" />
		// 	<ellipse cx="206.55" cy="691.34" rx="23.11" ry="3.17" fill="#1473fa" opacity="0.1" />
		// 	<ellipse cx="102.27" cy="679.19" rx="23.11" ry="3.17" fill="#1473fa" opacity="0.1" />
		// 	<ellipse cx="241.99" cy="716.9" rx="16.43" ry="2.26" fill="#1473fa" opacity="0.1" />
		// 	<ellipse cx="150.1" cy="714.64" rx="16.43" ry="2.26" fill="#1473fa" opacity="0.1" />
		// 	<path
		...
		// 		strokeMiterlimit="10"
		// 	/>
		// 	<path d="M230.83,580.64s-13.15,8.86-9,22.19" transform="translate(-43.1 -37.14)" fill="none" stroke="#565987" strokeMiterlimit="10" />
		// 	<path d="M184.61,588.53s8-8.18,17.83-3.67" transform="translate(-43.1 -37.14)" fill="none" stroke="#565987" strokeMiterlimit="10" />
		// 	<path
		...
		// 		strokeMiterlimit="10"
		// 	/>
		// 	<line x1="155.59" y1="639.61" x2="164.89" y2="639.61" fill="none" stroke="#565987" strokeMiterlimit="10" />
		// 	<line x1="166.73" y1="660.75" x2="181.31" y2="661.37" fill="none" stroke="#565987" strokeMiterlimit="10" />
		// 	<line x1="175.6" y1="643.84" x2="174.02" y2="651.43" fill="none" stroke="#565987" strokeMiterlimit="10" />
		// 	<line x1="191.11" y1="666.95" x2="190.82" y2="673.85" fill="none" stroke="#565987" strokeMiterlimit="10" />
		// 	<path
		...
		// 		strokeMiterlimit="10"
		// 	/>
		// 	<line x1="258.01" y1="639.61" x2="248.71" y2="639.61" fill="none" stroke="#565987" strokeMiterlimit="10" />
		// 	<line x1="246.87" y1="660.75" x2="232.29" y2="661.37" fill="none" stroke="#565987" strokeMiterlimit="10" />
		// 	<line x1="238" y1="643.84" x2="239.58" y2="651.43" fill="none" stroke="#565987" strokeMiterlimit="10" />
		// 	<line x1="222.5" y1="666.95" x2="222.78" y2="673.85" fill="none" stroke="#565987" strokeMiterlimit="10" />
		// 	<path
		...
		// 		fill="#5e5a6b"
		// 	/>
		// 	<path d="M360.84,549.25s15.76-6.12,8,1.68-22.64,7.35-22.64,7.35Z" transform="translate(-43.1 -37.14)" opacity="0.1" />
		// 	<path d="M333.9,518s-8.87,4.9-7.19,9.64S333.9,518,333.9,518Z" transform="translate(-43.1 -37.14)" opacity="0.1" />
		// 	<path
		// 		d="M325,480.08a9.28,9.28,0,0,1-8.73,4.74C309.88,484.67,325,480.08,325,480.08Z"
		// 		transform="translate(-43.1 -37.14)"
		// 		opacity="0.1"
		// 	/>
		// 	<path d="M241.78,412s3.37,10.41,0,11.17S241.78,412,241.78,412Z" transform="translate(-43.1 -37.14)" opacity="0.1" />
		// 	<path
		...
		// 		fill="#464353"
		// 	/>
		// 	<path d="M261.52,376.78S294,387,296.41,388.29,261.67,380.3,261.52,376.78Z" transform="translate(-43.1 -37.14)" opacity="0.1" />
		// 	<path d="M282,392.39s-8.54,4.75-11.6,3.06S282,392.39,282,392.39Z" transform="translate(-43.1 -37.14)" opacity="0.1" />
		// 	<path d="M308.81,335.63s8.22,43.91-3.93,56.76Z" transform="translate(-43.1 -37.14)" opacity="0.1" />
		// 	<path
		...
		// 		fill="#464353"
		// 	/>
		// 	<polygon points="242.9 370.45 246.5 380.12 240.43 385.86 240.15 387.59 226.68 395.34 222.4 384.53 242.9 370.45" opacity="0.1" />
		// 	<polygon points="242.9 369.84 246.5 379.5 240.43 385.25 240.15 386.98 226.68 394.73 222.4 383.92 242.9 369.84" fill="#5e5a6b" />
		// 	<g opacity="0.1">
		// 		<path
