...
Test + Resume based Shortlist
3 Rounds of technical Interview
1 HR Round

##  Preparation Resources
https://docs.google.com/document/d/1361vh1zuKTrCXR_DH0WVzJ1cBWjMWJHnpSqtg6jwT
Os/edit#
...
Exponent
PM School
These resources are more than enough for a person targeting Product Profile.

## Advice for students (dos and don’ts)? 
In First two rounds they basically grill you and expect quick answers and round 3 is relatively
more relaxing.
If you are shortlisted for multiple profiles in multiple industries for example consulting, product
then stick to only one rather than applying for each and every profile which will
