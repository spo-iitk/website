...
Medha Srivastava, studying in IIT Kanpur as a  student in Medha Srivastava
210603
Mechanical engineering -Btech will do
...
Oracle
JLR
Dr Reddy (1 st round cleared )

## Insights on the Selection Process
The test comprised two sections: the first focused on core concepts(it was not also too much ) ,
...
I also prepared for sde .
Coding ninja
Youtube- striver

## Advice for students (dos and don’ts)? 
Core – thermo important mechanics
