...
description: 'Sawan H N: BNY Mellon(Companies BNY Mellon

 Intern Profiles Software Engineering Intern)'
date: '2024-06-28'
tags: Companies BNY Mellon

 Intern Profiles Software Engineering Intern,BNY Mellon,Internship
imageUrl: ''
---

Sawan H N, studying in IIT Kanpur as a  student in Name: Sawan H N
...
Programme: B.Tech. will do
 summer internship in Companies BNY Mellon

Intern Profiles Software Engineering Intern profile at BNY Mellon. Here are some brief
insights.
...
BNY Mellon (Software Engineering Intern)

## Insights on the Selection Process
There were 3 rounds , 2 technical and one HR.
...
project (CS220) and discussed about some non-technical situations.

##  Preparation Resources
InterviewBit (completed almost all the topics)

LeetCode (for some medium to hard questions on graphs)

## Advice for students (dos and don�ts)? 
Be consistent and use the summer break properly , and prepare the resume nicely before
