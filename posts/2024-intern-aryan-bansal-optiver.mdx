...
Aryan Bansal, studying in IIT Kanpur as a  student in Name: Aryan Bansal
Roll No. : 200198
Branch: MTH-CSE
Programme: Double-Major (B.Tech) will do
...
tests involve questions on coding & Probability.
...
Since most profiles require coding it is best to prioritize coding from the very start during the
summers.
